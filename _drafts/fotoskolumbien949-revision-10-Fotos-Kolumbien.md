...
date: '2012-04-24T21:22:38+02:00'
author: Pädi
layout: revision
guid: 'http://www.zweimalweltbitte.ch/2012/04/949-revision-10/'
permalink: '/?p=959'
---

<div id="picasaGallery"></div><script type="text/javascript">
        $j = jQuery.noConflict();
        $album = "https://picasaweb.google.com/data/feed/base/user/patrikth/albumid/5725534356996189137?kind=photo&thumbsize=104c&imgmax=800&access=public&alt=json&callback=?";
